...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 641cd070-08bb-4970-9ac6-755f8b224de5
```

> `641cd070-08bb-4970-9ac6-755f8b224de5` is the password of the certificate, you can change it to any password you want.
